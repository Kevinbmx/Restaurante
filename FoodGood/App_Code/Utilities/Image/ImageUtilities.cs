...
namespace FoodGood.Utilities
{
    ...
    public class ImageUtilities
    {
        ...
        public static bool ImageCacheEnabled
        {
            get
            {
                try
                {
                    return Boolean.Parse(System.Configuration.ConfigurationManager.AppSettings["ImageCacheEnabled"]);
                }
                catch (Exception ex)
                {
                    log.Error("Error al hacer conversion de valor de web.config ImageCacheEnabled", ex);
                    return false;
                }
