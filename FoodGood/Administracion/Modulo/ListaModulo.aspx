                        ...
                        <asp:GridView runat="server" ID="ListaAreaModuloGridView" CssClass="table table-striped" OnRowDataBound="ListaAreaModuloGridView_RowDataBound" AutoGenerateColumns="false" OnRowCommand="ListaAreaModuloGridView_RowCommand"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Nuevo Modulo" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="NuevoImageButton" runat="server" CommandName="Nuevo" CommandArgument='<%# Eval("AreaId") %>' CssClass="text-success img-buttons" Text="<i class='fa fa-user-plus' style='color:#1ab394'></i>" />
                                    </ItemTemplate>
