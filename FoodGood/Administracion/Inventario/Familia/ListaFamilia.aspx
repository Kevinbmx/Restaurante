    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row">
                <div class="col-md-12">
                    <p>
                        <asp:LinkButton ID="NewFamiliaButton" runat="server" OnClick="NewFamiliaButton_Click" CssClass="btn btn-primary "><i class='fa fa-user-plus'></i> Nueva Familia</asp:LinkButton>
                    </p>
                </div>
                <div class="col-md-12">
                    <div class="row">
                                ...
                                <asp:TemplateField HeaderText="Eliminar" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="DeleteImageButton" runat="server" CommandName="Eliminar" CssClass="text-danger img-buttons" Text="<i class='fa fa-trash-o'></i>"
                                            ...
                                            OnClientClick="return confirm('¿Está seguro de eliminar esta Familia?')" />
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" Width="50px"></ItemStyle>
                                    <ItemStyle VerticalAlign="Middle"></ItemStyle>
                                </asp:TemplateField>
                                <asp:BoundField DataField="DescripcionForDisplay" HeaderText="Familia" />
                            </Columns>
                        </asp:GridView>
                        <asp:Panel ID="errorFamilia" runat="server" Visible="false">
                            <asp:Label runat="server">No se encuentra ninguna Familia</asp:Label>
                        </asp:Panel>
                    </div>
                </div>
            </div>
