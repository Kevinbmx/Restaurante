<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FoodGood.aspx.cs" Inherits="FoodGood" %>
...
<head runat="server">
    <title></title>
    <%--<link href="App_Themes/FoodGood/bootstrap.min.css" rel="stylesheet" />--%>
    <%--<link href="App_Themes/FoodGood/font-awesome.min.css" rel="stylesheet" />--%>
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no" />
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800' rel='stylesheet' type='text/css' />
    <link href='https://fonts.googleapis.com/css?family=Merriweather:400,300,300italic,400italic,700,700italic,900,900italic' rel='stylesheet' type='text/css' />
    <%--<link href="App_Themes/FoodGood/magnific-popup.css" rel="stylesheet" />--%>
    <%--<link href="App_Themes/FoodGood/Style.css" rel="stylesheet" />--%>
</head>
<body id="page-top">
